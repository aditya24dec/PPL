          ...
          <div className="content">
            <div className="content_rgt">
              <div className="register_sec">
                ...
                <ul>
                  <li><span>Username</span><input type="text" placeholder="Enter your username" /></li>
                  <li><span>Password</span><input type="text" placeholder="Enter your password" /></li>
                  <li><span>Email</span><input type="text" placeholder="Enter your email" /></li>
                  <li><span>First Name</span><input type="text" placeholder="Enter your first name" /></li>
                  <li><span>Last Name</span><input type="text" placeholder="Enter your last name" /></li>
